      ...
      <motion.div variants={fadeIn("down", "spring", index * 0.5, 0.75)}>
        ...
        >
          <div className=' w-full h-[160px] shadow-inner shadow-purple-400 '>
            ...
            <div className={` ${deploy_link ? 'visible' : 'hidden'} absolute inset-x-12 inset-y-0 flex justify-end m-3 card-img_hover`}>
              <div
...
const Works = () => {
  return (
    <>
      ...
      <div className='mt-20 lg:flex justify-between grid sm:grid-cols-2'>
