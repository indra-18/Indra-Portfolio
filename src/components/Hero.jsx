    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        <div className='flex flex-col justify-center items-center mt-5'>
          <div className='w-5 h-5 rounded-full bg-[#ffbd42]' />
          <div className='w-1 sm:h-80 h-40 bg-gradient-to-b from-orange-300 to-slate-800' />
        </div>

        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#ffbd42]'>Indra</span>
          </h1>
